#!/usr/bin/env node
/**
 * Content-aware tag generation for articles 501-600.
...
wb = openpyxl.load_workbook('/home/ubuntu/upload/CTCTags501-600worksheet.xlsx')
ws = wb.active
rows = []
...
const outPath = '/home/ubuntu/tags_501_600.json';
