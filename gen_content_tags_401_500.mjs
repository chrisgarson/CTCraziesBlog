#!/usr/bin/env node
/**
 * Content-aware tag generation for articles 401-500.
...
wb = openpyxl.load_workbook('/home/ubuntu/upload/CTCTags401-500worksheet.xlsx')
ws = wb.active
rows = []
...
const outPath = '/home/ubuntu/tags_401_500.json';
