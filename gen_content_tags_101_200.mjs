#!/usr/bin/env node
/**
 * Content-aware tag generation for articles 101-200.
...
wb = openpyxl.load_workbook('/home/ubuntu/upload/CTCTags101-200worksheet.xlsx')
ws = wb.active
rows = []
...
const outPath = '/home/ubuntu/tags_101_200.json';
