#!/usr/bin/env node
/**
 * Content-aware tag generation for articles 301-400.
...
wb = openpyxl.load_workbook('/home/ubuntu/upload/CTCTags301-400worksheet.xlsx')
ws = wb.active
rows = []
...
const outPath = '/home/ubuntu/tags_301_400.json';
