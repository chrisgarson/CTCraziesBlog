  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <ArticleBlock
        ...
        tags={["Virginia", "Election Fraud", "Democrat Party", "Politics"]}
      />
      <ArticleBlock
      ...
      <ArticleBlock
        ...
        tags={["Los Angeles", "Corruption-Fraud", "Government", "Democrat Party"]}
      />
      <Pagination currentPage={42} totalPages={58} />
    </div>
  );
}
