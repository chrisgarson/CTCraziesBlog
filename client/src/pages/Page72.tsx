  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ArticleBlock
        ...
        imageSrc="/post21_clean.jpg"
        tags={["California", "Corruption-Fraud", "Ilhan Omar"]}
      />
      </div>
      <Pagination currentPage={72} totalPages={73} />
