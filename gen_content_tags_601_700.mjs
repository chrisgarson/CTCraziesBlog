#!/usr/bin/env node
/**
 * Content-aware tag generation for articles 601-700.
...
wb = openpyxl.load_workbook('/home/ubuntu/upload/CTCTags601-700worksheet.xlsx')
ws = wb.active
rows = []
...
// Known news sources to filter post-generation
const NEWS_SOURCES = new Set([
  ...
  'the epoch times','national pulse','the national pulse','revolver news','revolver',
...
async function generateTags(headline, articleText) {
  ...
  // Safety filter: remove news sources and banned words
...
const outPath = '/home/ubuntu/tags_601_700.json';
