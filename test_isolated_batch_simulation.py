...
class IsolatedBatchSimulationTests(unittest.TestCase):
    def test_simulation_exercises_twenty_article_batch_without_production_changes(self):
        ...
        self.assertEqual(result["totalArticlesAfterSimulation"], 1520)
        self.assertEqual(result["pagesAfterSimulation"], 76)
        self.assertEqual(result["pageOneNums"], list(range(1520, 1500, -1)))
        self.assertEqual(result["pageTwoFirstNum"], 1500)
