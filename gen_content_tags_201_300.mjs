#!/usr/bin/env node
/**
 * Content-aware tag generation for articles 201-300.
...
wb = openpyxl.load_workbook('/home/ubuntu/upload/CTCTags201-300worksheet.xlsx')
ws = wb.active
rows = []
...
const outPath = '/home/ubuntu/tags_201_300.json';
